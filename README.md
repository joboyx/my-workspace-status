...
Agent map of PTY vs desktop `#[ignore]`, plus `WS_STATUS_UPDATE_CHECK_STORE`: [AGENTS.md](./AGENTS.md).

### Coverage

`cargo test --workspace` covers the snapshot contract, CLI flags, discovery, and the real-TTY TUI path (PTY, Unix):
