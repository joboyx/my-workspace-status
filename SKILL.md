...
| `;`                                   | comment overlay on the focused numbered diff line, or an object comment on a commit / non-default branch / worktree. Without highlight, `;` opens the stored span that covers that line. Empty Enter deletes that span. Left / Right / Home / End move the caret; insert and delete apply at the caret |
