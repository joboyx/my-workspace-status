...
| Double-click Enter | `pty_double_click_enters_on_hit_row` | — | Two SGR clicks. Tree focuses right. Graph drills to files. Files drill to diff. Single-click must not |
