...
| Event-loop freeze / overlay ticks / graph autoload gates | `tui/event_pump.rs` + `tui/app.rs` (`run_loop`, `run_work_pumped`, `run_capped_pumped`, `load_right_pumped`; CI: `tty_event_loop_must_not_call_sync_pane_git`) |
