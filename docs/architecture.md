...
A 1-row tab strip sits above the panes (`tui/tabs.rs`, painted in `tui/render.rs`). Workspace is always first. Session compare tabs follow. Click a tab to switch. There is no mouse close in v1.
