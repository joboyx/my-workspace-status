...
use super::keys::{InputMode, LastGChordPress, DOUBLE_TAP_MS};
use super::ops::{
...
pub struct AppState {
    ...
    /// Last `g`-chord Press. Typeless CSI-u echoes of that key are dropped.
    pub(crate) last_g_chord_press: Option<LastGChordPress>,
